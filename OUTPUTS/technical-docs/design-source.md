...
| Dashboard - Care Home Mgmt | Tasks Calendar View | `OUTPUTS/design-exports/US-12-tasks-calendar__tasks-calendar-view__20260501.png` | [US-12](../../SPEC/user-stories.md) — Vista de agenda semanal |
...
| `TasksView.vue` | `src/business/agenda/presentation/views/TasksView.vue` | Tasks Calendar View (`c4df0dcfc4114cb29deb834b50647f00`) | `OUTPUTS/design-exports/US-12-tasks-calendar__tasks-calendar-view__20260501.png` |
