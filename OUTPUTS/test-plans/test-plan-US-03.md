...
<!-- RESOLUTION(merge/2026-04-18): Both PR branches had conflicting versions of this file.
     develop (HEAD) had a detailed TC structure with seed data from a different branch.
     chore/hooks-husky had a comprehensive version with full Vitest/Playwright code examples.
     Decision: Keep the hooks-branch version (more complete, includes code examples) and
     prepend the Acceptance Criteria section from develop as it captures additional edge cases.
     TODO(reviewer): Review whether TC-A3/TC-A4/TC-A5 from the original version should be
     added as additional test cases to the hooks-branch version. -->

## 1. Acceptance Criteria to Cover

<!-- From develop branch — preserved as supplementary acceptance criteria -->
