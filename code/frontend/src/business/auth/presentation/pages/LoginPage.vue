...
<template>
  ...
  <div class="login-page">
    ...
    <div class="login-card">
      ...
      <div class="login-form__divider">
        <div class="login-form__divider-line" aria-hidden="true" />
        <span class="login-form__divider-text">o continuar con Google</span>
        <div class="login-form__divider-line" aria-hidden="true" />
      </div>
      ...
      >
        <svg class="login-form__google-icon" viewBox="0 0 24 24" aria-hidden="true">
          <path
...
.login-form__google:hover:not(:disabled) {
